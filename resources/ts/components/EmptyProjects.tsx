...
const EmptyProjects: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            <Typography sx={{ color: '#777', textAlign: 'center', maxWidth: 280, mb: 2 }}>This is where you'll find your projects.</Typography>

            <Button
                variant="contained"
                onClick={handleCreate}
                sx={{ bgcolor: '#1F8505', '&:hover': { bgcolor: '#155017' }, textTransform: 'none', borderRadius: 2, px: 3 }}
            >
                Start a project
            </Button>
        </Box>
