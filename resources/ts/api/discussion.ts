...
export const discussionApi = {
    ...
    async getResponses(data: DiscussionResponsesRequest): Promise<DiscussionResponsesResponse> {
        const response = await apiClient.getClient().get<DiscussionResponsesResponse>(
            endpoints.discussion_responses.replace('{id}', data.discussion_id.toString())
        );
        return response.data;
    },
    ...
    async create(data: CreateDiscussionRequest): Promise<CreateDiscussionResponse> {
        const response = await apiClient.getClient().post<CreateDiscussionResponse>(
            endpoints.discussion_create, 
            data
        );
        return response.data;
    },
    ...
    async update(data: UpdateDiscussionRequest): Promise<UpdateDiscussionResponse> {
        const response = await apiClient.getClient().put<UpdateDiscussionResponse>(
            endpoints.discussion_update.replace('{id}', data.discussion_id.toString()),
    ...
    async delete(data: DeleteDiscussionRequest): Promise<DeleteDiscussionResponse> {
        const response = await apiClient.getClient().delete<DeleteDiscussionResponse>(
            endpoints.discussion_delete.replace('{id}', data.discussion_id.toString())
        );
        return response.data;
    },
    ...
    async updateInterest(data: InterestUpdateRequest): Promise<InterestUpdateResponse> {
        const response = await apiClient.getClient().post<InterestUpdateResponse>(
            endpoints.discussion_interest.replace('{id}', data.discussion_id.toString())
        );
        return response.data;
    },
};
