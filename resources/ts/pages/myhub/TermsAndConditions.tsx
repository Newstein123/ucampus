...
const TermsAndConditions: React.FC = () => (
    <SinglePageLayout title="Terms & Conditions">
        <Paper elevation={0} sx={{ bgcolor: '#fff', borderRadius: 3, m: 2, p: 3, fontSize: 15 }}>
            ...
            <Typography sx={{ mb: 2 }}>
                Welcome to U Campus – a platform built for students and young creatives to share IT ideas, ask questions, exchange opinions, and learn
                together. Please read these Terms and Conditions ("Terms") carefully before using the U Campus app or website.
            </Typography>
            ...
            <Typography sx={{ mb: 2 }}>
                You’re responsible for what you upload. Only share files you own or control. You must have permission to use any content you upload.
