        ...
        <Box sx={{ maxWidth: 600, mx: 'auto', minHeight: '100vh', bgcolor: '#f7fafd', p: 0 }}>
            ...
            <Paper elevation={0} sx={{ bgcolor: '#fff', borderRadius: 3, m: 2, p: 3 }}>
                ...
                <Box component="form" onSubmit={handleSubmit(onSubmit)} sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                    ...
                    />
                    <Button type="submit" variant="contained" sx={{ bgcolor: '#1F8505', borderRadius: 2, fontWeight: 600, fontSize: 16, mt: 1, mb: 2, '&:hover': { bgcolor: '#176b03' } }} fullWidth>
                        {t('Submit')}
                    </Button>
                </Box>
                ...
                <Grid container spacing={1}>
                    <Grid item xs={6} sm={3}>
                        <Box component="button" onClick={() => window.open('tel:+959123456789', '_blank')} sx={{ bgcolor: '#e8f5e9', borderRadius: 2, p: 1, textAlign: 'center', fontSize: 13, mb: 1, width: '100%', border: 'none', cursor: 'pointer' }}>
                    ...
                    <Grid item xs={6} sm={3}>
                        <Box component="button" onClick={() => window.open('mailto:support@ucampus.app', '_blank')} sx={{ bgcolor: '#e8f5e9', borderRadius: 2, p: 1, textAlign: 'center', fontSize: 13, mb: 1, width: '100%', border: 'none', cursor: 'pointer' }}>
                    ...
                    <Grid item xs={6} sm={3}>
                        <Box component="button" onClick={() => window.open('https://t.me/ucampus', '_blank')} sx={{ bgcolor: '#e8f5e9', borderRadius: 2, p: 1, textAlign: 'center', fontSize: 13, mb: 1, width: '100%', border: 'none', cursor: 'pointer' }}>
                            <Typography sx={{ fontWeight: 600, fontSize: 13 }}>{t('Telegram')}</Typography>
                            <Typography sx={{ color: '#1F8505', fontSize: 13 }}>@ucampus</Typography>
                        </Box>
                    </Grid>
                    <Grid item xs={6} sm={3}>
                        <Box component="button" onClick={() => window.open('https://www.instagram.com/ucampus', '_blank')} sx={{ bgcolor: '#e8f5e9', borderRadius: 2, p: 1, textAlign: 'center', fontSize: 13, mb: 1, width: '100%', border: 'none', cursor: 'pointer' }}>
